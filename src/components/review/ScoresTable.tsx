    ...
    <div className="border rounded-lg overflow-hidden text-sm" data-section="scores-table">
      ...
      <div className="divide-y">
        ...
        <div className="flex items-center px-3 py-1.5">
          ...
          <div className="flex-1" data-field="ai-score">
            ...
            {property.ai_score != null && (
              <Badge variant="outline" className={`ml-1 text-[10px] ${aiC.text} ${aiC.bg} ${aiC.border}`}>{aiC.label}</Badge>
            )}
          </div>
        </div>
        {/* Lead */}
        <div className="flex items-center px-3 py-1.5">
          ...
          <div className="flex-1" data-field="lead-score">
            ...
            {property.lead_score != null && (
              <span className={`ml-1 text-xs font-bold ${ldC.text}`}>{ldC.label}</span>
            )}
          </div>
        </div>
        {/* Meu Score */}
        ...
        <div className="flex items-center px-3 py-1.5">
          ...
          <div className="flex-1 font-bold text-base" data-field="price">
        ...
        <div className="flex items-center px-3 py-1.5">
          ...
          <div className="flex-1 font-bold text-base" data-field="offer">
            ...
            {discountPct != null && (
              <Badge variant={discountPct >= 35 ? 'default' : 'secondary'} className="ml-1 text-[10px]">-{discountPct}%</Badge>
            )}
          </div>
        </div>
        {/* Avg Comps */}
        {avgCompPrice != null && avgCompPrice > 0 && (
          <div className="flex items-center px-3 py-1.5">
            ...
            <div className="flex-1 text-base text-muted-foreground" data-field="avg-comps">
        ...
        {property.mao != null && (
          <div className="flex items-center px-3 py-1.5">
            ...
            <div className="flex-1 font-bold text-base text-blue-600" data-field="mao">
        ...
        <div className="flex items-center px-3 py-1.5">
          ...
          <div className="flex-1 font-bold text-base" data-field="sqft">
            ...
            {property.lot_size != null && property.lot_size > 0 && (
              <span className="text-muted-foreground text-xs ml-2 font-normal">Lote: {property.lot_size.toLocaleString()}</span>
            )}
          </div>
        </div>
