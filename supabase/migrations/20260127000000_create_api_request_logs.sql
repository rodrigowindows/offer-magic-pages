...
CREATE INDEX idx_api_request_logs_api_source ON public.api_request_logs(api_source);
CREATE INDEX idx_api_request_logs_created_at ON public.api_request_logs(created_at DESC);
CREATE INDEX idx_api_request_logs_request_address ON public.api_request_logs(request_address);
CREATE INDEX idx_api_request_logs_http_status ON public.api_request_logs(http_status);
CREATE INDEX idx_api_request_logs_parsed_comps_count ON public.api_request_logs(parsed_comps_count);
